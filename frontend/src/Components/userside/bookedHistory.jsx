...
//                   {showdeleteModal && (
//                     <div className="popup1"  style ={{background:"none"}}onClick={() => setShowDeleteModal(false)}>
//                       <div className="popup-con1">
//                         <h2>Are you sure you want to delete this ticket?</h2>
//                         <h4>when your ticket is cancelled the money will refund with in 24hrs</h4>
//                         <div className="yesnobuttton">
//                           <button onClick={() => setShowDeleteModal(false)}>No</button>
//                           <button onClick={() => handleDelete(booking._id,booking.from, booking.to, booking.date, booking.no, booking.Class, booking.gmail,booking.passengerName,booking.amount)}>Yes</button>
//                         </div>
//                       </div>
//                     </div>
//                   )}
//                 </div>
//                 <button  className="delete-button"  onClick={() => setShowDeleteModal(true)} disabled={isPastBooking} >
